...
public class ProductOrderServiceApplication {
    public static void main(String[] args) {
        ...
        System.out.println("Is user " + orderDto1.getUser().getNickname() + " just ordered " + orderDto1.getProduct().getProductName() + "? " + orderDto1.isProductOrdered());

        OrderDto orderDto2 = processor.process(orderRequest2);
        System.out.println("Is user " + orderDto2.getUser().getNickname() + " just ordered " + orderDto2.getProduct().getProductName() + "? " + orderDto2.isProductOrdered());
